...
(() => {
  ...
  var Vector3 = class _Vector3 {
    ...
    distanceToSquared(v) {
      const dx = this.x - v.x, dy = this.y - v.y, dz2 = this.z - v.z;
  ...
  function WebGLBackground(renderer2, cubemaps, cubeuvmaps, state2, objects2, alpha, premultipliedAlpha) {
  ...
  var WebGLRenderer = class {
    constructor(parameters = {}) {
      ...
      let properties, textures, cubemaps, cubeuvmaps, attributes, geometries, objects2;
      ...
      function initGLContext() {
        ...
        background = new WebGLBackground(_this, cubemaps, cubeuvmaps, state2, objects2, _alpha, premultipliedAlpha);
        shadowMap = new WebGLShadowMap(_this, objects2, capabilities);
        ...
        if (visible) {
          if (object.isGroup) {
            ...
            if (!object.frustumCulled || _frustum.intersectsSprite(object)) {
              ...
              const geometry = objects2.update(object);
              const material = object.material;
              if (material.visible) {
  ...
  var _pitchQ = new Quaternion();
  var _yawQ = new Quaternion();
  function dz(v) {
  ...
  scene.add(axes);
  var ambientLight = new AmbientLight(16777215, 0.15);
  scene.add(ambientLight);
  var dirLight1 = new DirectionalLight(16777215, 1.2);
  dirLight1.position.set(1, -1, 2);
  scene.add(dirLight1);
  var dirLight2 = new DirectionalLight(16777215, 0.5);
  dirLight2.position.set(-1, 1, -1);
  scene.add(dirLight2);
  var NOZZLE_HEIGHT = 10;
  var nozzleGeo = new ConeGeometry(4, NOZZLE_HEIGHT, 16);
  var nozzleMat = new MeshPhongMaterial({
    color: 16777215,
    transparent: true,
    opacity: 0.45,
    depthWrite: false,
  ...
  var nozzleMesh = new Mesh(nozzleGeo, nozzleMat);
  ...
  function buildDiamondTube(positions, N, nozzleSize) {
    ...
    geo.setAttribute("position", new BufferAttribute(posOut, 3));
    geo.setIndex(new BufferAttribute(indexOut, 1));
    return geo;
  }
  ...
  var objects = [];
  var segmentMetas = [];
  var allCoords = new Float32Array(0);
